 ...
 *
 */
public class DrawableAND extends DrawableComponent{

    public DrawableAND(Context context, int inputNumber, int outputNumber){
        super(context, inputNumber, outputNumber, "AND");
    }
