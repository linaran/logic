 ...
 *
 */
public class DrawableXOR extends DrawableComponent{

    public DrawableXOR(Context context, int inputNumber, int outputNumber){
        super(context, inputNumber, outputNumber, "XOR");
    }
