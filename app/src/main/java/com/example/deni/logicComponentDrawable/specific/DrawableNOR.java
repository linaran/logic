 ...
 *
 */
public class DrawableNOR extends DrawableComponent{

    public DrawableNOR(Context context, int inputNumber, int outputNumber){
        super(context, inputNumber, outputNumber, "NOR");
    }
