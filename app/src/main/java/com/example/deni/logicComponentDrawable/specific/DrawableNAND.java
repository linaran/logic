 ...
 *
 */
public class DrawableNAND extends DrawableComponent {

    public DrawableNAND(Context context, int inputNumber, int outputNumber){
        super(context, inputNumber, outputNumber, "NAND");
    }
